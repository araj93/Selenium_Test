...
public class TestCheckoutForRegisteredUser extends Base {

    @Test
    public void test_checkoutButtonExistingUser() throws InterruptedException {
        ...
        login.registeredUserCredentials("xyz@gmail.com","asdf23..");
        Thread.sleep(1000);
        ...
        cardNo.enterCardNumber("4509950162047728");
        Thread.sleep(2000);
...
//        Thread.sleep(2000);
        ...
        Thread.sleep(8000);
        ExtentTestManager.getTest().log(LogStatus.PASS, "Test Case (test_checkoutButton) Status is passed");
    }
